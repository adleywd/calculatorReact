...
export default class App extends Component {
	...
	setOperation = operation => {
		if (this.state.current === 0) {
			...
			const values = [...this.state.values] // gera clone do array.
			try {
				values[0] = eval(`${values[0]} ${this.state.opereation} ${values[1]}`);
			} catch (e) {
	...
	// this.addDigit pega da label direto ou adicionar o arrowfunction e passar o valor
	render() {
		return (
